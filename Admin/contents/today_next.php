...
$tpl->set_file('html',"today_next.htm",1); // here 1 mean extract blocks
...
$list['data1_TNG_checked'] = "";
$list['data1_IMG_checked'] = "";
if ($list['data1'] == 'IMG') $list['data1_IMG_checked'] = " checked";
elseif ($list['data1'] == 'NXTIMG') $list['data1_NXTIMG_checked'] = " checked";
else $list['data1_TNG_checked'] = " checked";
