...
?>
	<tr>
		...
		<td bgcolor="#F8F8EA">&nbsp; <?php echo $list['kind']?></td>
	</tr>
	<tr>
	...
	<tr align="center">
	<td colspan="2" bgcolor=#efefef><a href='<?php echo $href['edit']?>'><img src="images/btn_modi.gif" width="40" height="17" border="0" ></a>&nbsp; 
	<a href='<?php echo $href['delete']?>' onClick="javascript: return confirm('해당 일정을 정말로 삭제하시겠습니까?');"><img src="images/btn_del.gif" width=40 height=17 border=0></a>&nbsp;
