...
function default_imgview(){
	if (eval("document.form.default_images.checked") == false){
		...
		document.form.default_images.value = "/h_images/catch_1.swf";
		document.form.new_images.value = "/h_images/catch_1.swf";
...
function dreamkos_imgview(){
	...
	if(event.srcElement.value.match(/(.jpg|.jpeg|.gif|.png|.JPG |.GIF|.PNG|.JPEG)/)){
		...
		swf.innerHTML="&nbsp;<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0' width='200' height='65'> <param name='movie' value='"+event.srcElement.value+"'>	<param name='play' value='true'>	<param name='loop' value='true'>	<param name='quality' value='high'>	<embed src='"+event.srcElement.value+"' play='true' loop='true' quality='high' pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' width='200' height='65'></embed></object>";
...
<input type="hidden" name="mode" value="top_banner">
<input type="hidden" name="new_images" value="">
<input type="hidden" name="check_default" value="0">
 <table border=0 cellpadding=0 cellspacing=0 width=880 bgcolor=#F8F8EA>
	<tr>
	<td width="20%" colspan=2 valign="top"><table width="159" border="0" cellspacing="0" cellpadding="0">
		<tr>
	...
	<td width="80%" colspan="2" align="center" bgcolor="#F8F8EA">		<table width="97%" align="center" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="22"><img src="/images/admin/tbox_l.gif" width="22" height="22"></td>
			<td background="/images/admin/tbox_bg.gif"><b>배너관리 &gt;&gt; 상단 배너관리 </b></td>
			<td align="right" width="5"><img src="/images/admin/tbox_r.gif" width="5" height="22"></td>
		</tr>
	</table>
		<br>
	<table border='0' cellpadding='4' cellspacing='1' width='97%' bgcolor='#aaaaaa'>
	<tr height=25 bgcolor=#F8F8EA>
		<td height="25" colspan="2" bgcolor="#F0EBD6" align="center"><strong>상단 배너관리</strong></td>
	</tr>
		<tr height=25>
			<td width=120 height="30" align="center" bgcolor="#D2BF7E">기본설정</td>
		<td bgcolor=#F8F8EA><input type="checkbox" name="default_images" value="/h_images/catch_1.swf" onClick='default_imgview();dreamkos_imgview()' >
			기본설정으로 (플래시 파일), (배너 사이즈 : 200px * 65 px) </td>
		</tr>
		<tr height=25>
			<td bgcolor="#D2BF7E" align="center">현재 이미지</td>
		<td height="80" bgcolor=#F8F8EA>						&nbsp; <?php	
if(strtolower(substr($SITE['top_banner'], -3)) == 'gif' || strtolower(substr($SITE['top_banner'], -3)) == 'jpg' || strtolower(substr($SITE['top_banner'], -3)) == 'bmp') echo "<img src='{$SITE['top_banner']}'>";
				elseif (strtolower(substr($SITE['top_banner'], -3)) == 'swf') echo "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0' width='200' height='65'> <param name='movie' value='{$SITE['top_banner']}'>	<param name='play' value='true'>	<param name='loop' value='true'>	<param name='quality' value='high'>	<embed src='{$SITE['top_banner']}' play='true' loop='true' quality='high' pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' width='200' height='65'></embed></object>";
				else echo "/images/admin/dot.gif"; 
?> </td>
		</tr>
		<tr height=25>
		...
		<tr height=25>
			...
			<td bgcolor=#F8F8EA>
			<input name='upfile' type='file' id="upfile" onChange='dreamkos_imgview()' size='70'> </td>
		</tr>
		<tr height=50 valign=middle>
		<td colspan="2" align="center" bgcolor="#F8F8EA">
			<input type="submit" value=" 저 장 하 기 ">	</td>
		</tr>
	</table></td>
	</tr>
</table>
