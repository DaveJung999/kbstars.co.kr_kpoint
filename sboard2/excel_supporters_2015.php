...
<table width="100%" border=0 cellpadding=2 cellspacing=0>
	<tr>
		<td align="center"><strong>신청자 이름</strong></td>
		<td align="center"><strong>성별</strong></td>
		<td align="center"><strong>생년월일</strong></td>
		<td align="center"><strong>연락처</strong></td>
		<td align="center"><strong>유니폼사이즈</strong></td>
		<td align="center"><strong>네이밍</strong></td>
	</tr>
<?php
...
// 게시판 맨 위에 무조건 공지글(type필드에 info인 것) 읽어오기
	...
	$sql = "select title, content, data1, data2, data3, data4, data5 from new21_board2_{$_GET['db']} where 1";
