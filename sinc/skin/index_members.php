...
switch($_SERVER['PHP_SELF']) {
	case '/smember/index.php' :
		$nevi = " &gt; 마이페이지";
		break;
	case '/sjoin/login.php' :
		$nevi = ' &gt; 로그인';
		break;
	case '/sjoin/findpasswd.php' :
		$nevi = ' &gt; ID/PW 찾기';
		break;
	case '/sjoin/index.php' :
		$nevi = ' &gt; 회원가입';
		break;
	case '/members/6.php' :
		$nevi = ' &gt; 실명인증 안내';
		break;
	case '/smember/profile.php' :
		$nevi = ' &gt; 회원정보수정';
		break;
	case '/members/9.php' :
		$nevi = ' &gt; 포인트 안내';
	...
	<tr>
		<td width="874" height="208">
			...
			<table style="line-height:100%; margin-top:0; margin-bottom:0;" border="0" cellpadding="0" cellspacing="0" width="100%" background="/img/sub-view-box-bg.gif">
				<tr>
					<td width="184">
									<p style="line-height:100%; margin-top:0; margin-bottom:0;"><span style="font-size:10pt;"><img src="/img/menu-title-9.gif" width="184" height="34" border="0"></span></p>
						<table align="right" border="0" cellpadding="0" cellspacing="0" width="158" height="100%" style="line-height:100%; margin-top:0; margin-bottom:0;">
							<tr>
								<td width="158" height="358">
									...
									<p style="line-height:100%; margin-top:0; margin-bottom:0;" align="right"><span style="font-size:10pt;"><script src="/swf/index.php?src=members&width=158&height=358"></script></span></p>
								</td>
							</tr>
							<tr>
								<td width="174">
