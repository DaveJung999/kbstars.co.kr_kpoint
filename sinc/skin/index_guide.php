...
<table border="0" cellpadding="0" cellspacing="0" width="1004" bgcolor="white" style="line-height:100%; margin-top:0; margin-bottom:0;">
	<tr>
		<td width="1250">
			<p style="line-height:100%; margin-top:0; margin-bottom:0;"><?php if($_SESSION['seUid'] && $_SESSION['seUserid']) { //로그인이 되어 있으면 ?><script src="/swf/index.php?src=sub8-1&width=1004&height=142"></script><?php } else { //로그인이 되어있지 않으면 ?><script src="/swf/index.php?src=sub8&width=1004&height=142"></script><?php } // end if ?>
			</p>
		</td>
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="1004" bgcolor="white" style="line-height:100%; margin-top:0; margin-bottom:0;">
	<tr>
		<td height="24" bgcolor="#574F43" background="/img/home-menu-title.gif">
			...
			&gt; 농구가이드 <font color="#FFFFFF"><?php echo $nevi;?></font></span></p>
		</td>
	</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="1004" bgcolor="white" style="line-height:100%; margin-top:0; margin-bottom:0;">
	<tr>
		<td width="874" height="208">
			...
			<table style="line-height:100%; margin-top:0; margin-bottom:0;" border="0" cellpadding="0" cellspacing="0" width="100%" background="/img/sub-view-box-bg.gif">
				<tr>
					<td width="184">
									<p style="line-height:100%; margin-top:0; margin-bottom:0;"><span style="font-size:10pt;"><img src="/img/menu-title-8.gif" width="184" height="34" border="0"></span></p>
						<table align="right" border="0" cellpadding="0" cellspacing="0" width="158" height="100%" style="line-height:100%; margin-top:0; margin-bottom:0;">
							<tr>
								<td width="158" height="358">
									...
									<p style="line-height:100%; margin-top:0; margin-bottom:0;" align="right"><span style="font-size:10pt;"><script src="/swf/index.php?src=guide&width=158&height=358"></script></span></p>
								</td>
							</tr>
							<tr>
								<td width="174">
