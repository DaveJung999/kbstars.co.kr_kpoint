...
<table border="0" cellpadding="0" cellspacing="0" width="1004" bgcolor="white" style="line-height:100%; margin-top:0; margin-bottom:0;">
	<tr>
		<td width="1250">
			<p style="line-height:100%; margin-top:0; margin-bottom:0;"><? if($_SESSION['seUid'] && $_SESSION['seUserid']) { //로그인이 되어 있으면 ?><script src="/swf/index.php?src=sub6-1&width=1004&height=142"></script><? } else { //로그인이 되어있지 않으면 ?><script src="/swf/index.php?src=sub6&width=1004&height=142"></script><? } // end if ?>
			</p>
		</td>
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="1004" bgcolor="white" style="line-height:100%; margin-top:0; margin-bottom:0;">
	<tr>
		<td height="24" bgcolor="#574F43" background="/img/home-menu-title.gif">
			...
			&gt; 팬커뮤니티 <font color="#FFFFFF"><?=$nevi?></font></span></p>
		</td>
	</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="1004" bgcolor="white" style="line-height:100%; margin-top:0; margin-bottom:0;">
