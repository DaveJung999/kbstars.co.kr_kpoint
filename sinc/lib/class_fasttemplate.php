...
//	reads it into a (potentially REALLY) big string
	...
	function get_template ($template)
	{
		...
		if( (!$contents) or (empty($contents)) )
		{
			...
			$this->error("get_template() failure: [{$template}] {$php_errormsg}",1);
		}
...
//	************************************************************
	...
	function clear_tpl ($fileHandle = "")
	{
		...
		else
		{
			...
			{
				if( (isset($this->$fileHandle)) || (isset($this->LOADED[$fileHandle])) )
				{
