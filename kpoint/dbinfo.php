<?php
 $dbinfo['table_kpoint'] = "{$SITE['th']}" . "kpoint";  // 포인트
 $dbinfo['table_kpointinfo'] = "{$SITE['th']}" . "kpointinfo";  // 포인트 회원 정보
 //$dbinfo['table_kmember'] = "{$SITE['th']}" . "kmember"; 
 $dbinfo['table_kpresent'] = "{$SITE['th']}" . "kpoint_present";  // 경품정보
 $dbinfo['table_logon'] = "{$SITE['th']}" . "logon";  // 사용자 정보
