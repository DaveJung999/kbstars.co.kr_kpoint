...
this.fontnames = {
	"굴림": "굴림, 돋움, Seoul, 한강체",
	"굴림체": "굴림체, 돋움체, Seoul",
	"바탕": "바탕, 궁서, AppleMyungjo",
	"바탕체": "바탕체, 궁서체, AppleMyungjo",
	"궁서": "궁서,바탕, AppleMyungjo",
...
this.btnList = {
    ...
    "bold":           ['Bold',                 '진하게',               'editor_action(this.id)',  'ed_format_bold.gif'],
    "italic":         ['Italic',               '기울임',             'editor_action(this.id)',  'ed_format_italic.gif'],
    ...
    "subscript":      ['SubScript',            '아래첨자',          'editor_action(this.id)',  'ed_format_sub.gif'],
    "superscript":    ['SuperScript',          '윗첨자',        'editor_action(this.id)',  'ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          '왼쪽 정렬',       'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        '가운데 정렬',     'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         '오른쪽 정렬',      'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    '문단 번호',       'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  '글머리 기호',      'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              '왼쪽여백 줄이기',    'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               '왼쪽여백 늘이기',    'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            '글자색',         'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            '배경색',   'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', '구분선',    'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           '하이퍼링크 삽입',    'editor_action(this.id)',  'ed_link.gif'],
    "insertimage":    ['InsertImage',          '그림(이미지) 삽입',       'editor_action(this.id)',  'ed_image.gif'],
    "inserttable":    ['InsertTable',          '표만들기',       'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             'HTML 소스 편집',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          '큰화면 편집기',     'editor_action(this.id)',  'fullscreen_maximize.gif'],
    "about":          ['about',                '도움말',  'editor_about(\''+objname+'\')',  'ed_about.gif'],
