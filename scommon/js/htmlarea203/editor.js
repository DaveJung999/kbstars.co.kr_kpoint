...
this.stylesheet1 = "http://"+ document.location.host + "/css/basic_text.css"; // full URL to stylesheet
this.stylesheet2 = "http://"+ document.location.host + "/css/link01.css"; // full URL to stylesheet
...
function editor_setmode(objname, mode) {
 ...
 // src="' +_editor_url+ 'popups/blank.html"
  ...
  //
	...
	var html = "";
	html += '<html><head>\n';
	if (config.stylesheet1) {
	  html += '<link href="' +config.stylesheet1+ '" rel="stylesheet" type="text/css">\n';
	  html += '<link href="' +config.stylesheet2+ '" rel="stylesheet" type="text/css">\n';
	}
	html += '<style>\n';
