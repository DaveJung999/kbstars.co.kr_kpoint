<!--
/*********************************
sitePHPbasic 공식 JS : 03/09/20 By Sunmin Park

사용: 
<script LANGUAGE="JavaScript" src="/scommon/js/inputcalendar.js" type="Text/JavaScript"></script>
<INPUT TYPE=text name="startdate" id="startdate" ONCLICK="Calendar(this);" VALUE="<?=$list[startdate]?>" size='10' readonly>
*********************************/
function changeEndHour(f){
...
function _changeEndHour(f){
	changeEndHour(f)
	changeEndMin(f)
}

function _changeEndMin(f){
	changeEndMin(f)
}

function changeDurHour(f){
	//var f= document.forms[0];
...
function Show_cal(sYear, sMonth, sDay) {
	...
	Cal_HTML = "<TABLE WIDTH=160 BORDER=0 CELLPADDING=0 CELLSPACING=0 ONMOUSEOVER=doOver(); ONMOUSEOUT=doOut(); STYLE='font-size:8pt;font-family:Tahoma;'>"
