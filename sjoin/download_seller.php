...
//=======================================================
$HEADER=array(
		auth	=>0, // 인증유무 (0:모두에게 허용, 숫자가 높을 수록 레벨업)
...
//=======================================================
	...
	$updir	= $_SERVER['DOCUMENT_ROOT'] ."/sshop2/upload/new21_seller";
...
//=======================================================
$sql = "select * from $table where userid='{$_GET['sellerid']}'";
...
if( !is_array($upfiles) ) {
	if(strlen($list['upfiles'])>0) { 
		...
		if($_GET['mode']) go_url("/scommon/seller/noimage.gif");
